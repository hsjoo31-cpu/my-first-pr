...
for _, s in sig.iterrows():
    ...
    for _, r in fut.iterrows():
        ...
        if d >= limit_date:
            ...
            reason = ("절반익절→만기" if partial_done else "3개월만기")
            break
...
tr.to_csv(os.path.join(BASE, "..", "trades_result_v3.csv"), index=False, encoding="utf-8-sig")
print("\n상세 내역 저장: kr_backtest/trades_result_v3.csv")
